...
from stable_diffusion.vae import (
    VAE_ResidualBlock,
    VAE_AttentionBlock,
)
...
class VAE_Encoder(nn.Sequential):
    ...
    def forward(self, x: torch.Tensor, noise: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            ...
            noise (torch.Tensor): Noise tensor of shape (Batch_Size, 4, Height/8, Width/8).
        Returns:
            torch.Tensor: Output tensor of shape (Batch_Size, 4, Height/8, Width/8).
        """
